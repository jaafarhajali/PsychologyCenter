...
public class DoctorsListPageImproved extends JFrame {
    ...
    public DoctorsListPageImproved(String condition, String source) {
    ...
    private JPanel createDoctorCard(int doctorId, String name, String speciality, double fees, String phone, String address) {
        ...
        appointmentButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                setVisible(false);
                new AppointmentPageImproved(doctorId, name, fees, selectedCondition, previousSource).setVisible(true);
            }
        });
