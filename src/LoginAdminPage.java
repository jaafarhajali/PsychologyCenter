...
log_but.addActionListener(new ActionListener(){
 public void actionPerformed(ActionEvent e){ 
   ...
   if(email.trim().isEmpty() || password.isEmpty()){
       JOptionPane.showMessageDialog(LoginAdminPage.this,"Please enter both email and password!");
       return;
   }
   ...
   if(rs.next()){
       ...
       if(loginSuccessful){
           ...
           JOptionPane.showMessageDialog(LoginAdminPage.this,"Wrong email or password!");
       }
   }
   else{
