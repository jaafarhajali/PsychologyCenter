...
public class LoginDrPageImproved extends JFrame {
    private Connection conn = null;
    private JLabel titleLabel, emailLabel, passwordLabel, doctorIconLabel;
    private JTextField emailField;
    private JPasswordField passwordField;
    private JButton loginButton, backButton;
    private JPanel mainPanel, formPanel, buttonPanel, headerPanel;

    public LoginDrPageImproved() {
    ...
    private void initializeComponents() {
        setTitle("Doctor Login - Psychology Center");
        setSize(450, 550);
    ...
    private void setupLayout() {
        ...
        headerPanel.add(doctorIconLabel);
    ...
    private void performLogin() {
        try {
            ...
            if(rs.next()) {
                ...
                if(loginSuccessful) {
                    // Hide login page and go to doctor appointment page
                    setVisible(false);
