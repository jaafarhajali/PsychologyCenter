...
public class AppointmentPageImproved extends JFrame {
    ...
    public AppointmentPageImproved(int doctorId, String doctorName, double fees) {
    ...
    public AppointmentPageImproved(int doctorId, String doctorName, double fees, String previousCondition, String previousSource) {
    ...
    private void addEventListeners() {
        ...
        backButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                setVisible(false);
                new DoctorsListPageImproved(previousCondition, previousSource).setVisible(true);
            }
        });
    }
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            new AppointmentPageImproved(1, "Dr. Sample Doctor", 150.0).setVisible(true);
        });
    }
}
